...
xls_path <- "data//French_example_CERES_SHELIA_SB_TestSam.xlsx"
...
source("D:\\Home\\sbuis\\Documents\\GitHub\\DSSAT-wrapper\\R\\DSSAT_wrapper.R")
...
model_options$out_files <- "PlantN.OUT"
