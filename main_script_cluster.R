...
if (length(args)>0) {
  ...
  library("SticsRFiles")
  library("SticsOnR")
  library("here",lib="/home/buiss/work_inra_ea/emmah/sbuis/myRlibs")
  ...
  data_dir= file.path(workspace,"stics_input_files", test_case,"TxtFiles")
...
if (test_case=="French") {
  ...
  xls_path <- file.path(here(),"data","French_example_STICS_BUIS.xlsx")
  if (regtest) {
