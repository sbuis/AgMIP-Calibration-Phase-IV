...
xls_path <- "D:\\Home\\sbuis\\Documents\\GitHub\\AgMIP-Calibration-Phase-IV\\data\\French_example_STICS_BUIS_test_special_char.xlsx"
...
model_wrapper <- model_test_wrapper
model_wrapper <- model_test_wrapper_without_var
model_wrapper <- model_test_wrapper_special_char
...
model_options$test_model <- "date_format"
model_options$test_model <- "date_ref"
model_options$test_model <- "date_bbch90_na"
model_options$test_model <- "early_end_date"
model_options$test_model <- "missing_var"
model_options$test_model <- "date_bbch90_999"
model_options$test_model <- "OK"																   
