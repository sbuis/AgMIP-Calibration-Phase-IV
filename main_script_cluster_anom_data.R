...
if (test_case=="French") {
  # xls_path <- file.path(here(),"data",paste0("protocol_descr_french_",variety,"_STICS.xlsx"))
  xls_path <- file.path(here(),"anom_data","French_example_STICS_BUIS.xlsx")
  if (regtest) {
    xls_path <- file.path(here(),"anom_data","protocol_descr_french_Apache_REGRESSION_TESTS.xlsx")
  }
...
template_path <- file.path(here(),"anom_data",paste0("cal_4_results_",test_case,suffix,"_numerical_modelName_contact_person.txt"))
